		 	...
		 	<div>                
                ...
                <div className="content-wrapper">
                    <div className="container-fluid">                        
                    	<div className="row">
                            <h1 className="col-md-12 heading primary-dark-font fancy-heading animated fadeInLeft">My Portfolio</h1>
                            <div className="col-md-12 portfolio-sec animated fadeInDown">
                                <Slider {...settings}>
